...
public class AsyncBatchEmitterFactoryTest {
    ...
    public void acceptsClientObjectFactory() {
        ...
        // given
        final BatchEmitterFactory emitterFactory = new AsyncBatchEmitterFactory();
    ...
    public void createsBatchEmitter() {
        ...
        // given
        final BatchEmitterFactory factory = new AsyncBatchEmitterFactory();
    ...
    public void loadingOrderCanBeOverriddenWithProperty() {
        ...
        // given
        final AsyncBatchEmitterFactory factory = new AsyncBatchEmitterFactory();
    ...
    public void defaultLoadingOrderIsReturnedIfOverrideNotSet() {
        ...
        // given
        final int expectedLoadingOrder = BatchEmitterFactory.DEFAULT_LOADING_ORDER + 9;
