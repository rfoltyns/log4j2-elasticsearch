...
public class ServerInfoTest {
    ...
    public void throwsOnInvalidUrl() {
        ...
        // given
        final String invalidUrl = "notvalid";

        // when
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new ServerInfo(invalidUrl));
    ...
    public void doesNotThrowOnHttpUrl() {
        ...
        // given
        final String validUrl = "http://localhost";

        // when
        final ServerInfo serverInfo = new ServerInfo(validUrl);
