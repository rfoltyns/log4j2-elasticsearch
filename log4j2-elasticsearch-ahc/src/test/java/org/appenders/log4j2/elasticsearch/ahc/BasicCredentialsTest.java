...
public class BasicCredentialsTest {
    ...
    static final String TEST_PASSWORD = "changeme";
    ...
    public void minimalBuilderTest() {
        ...
        // given
        final BasicCredentials.Builder builder = createTestBuilder();

        // when
        final BasicCredentials certInfo = builder.build();
    ...
    public void objectIsConfiguredWhenAllParamsAreSet() {
        ...
        // given
        final BasicCredentials BasicCredentials = createTestBuilder()
                .withUsername(TEST_USER)
                .withPassword(TEST_PASSWORD)
                .build();
