...
public class ElasticsearchDataStreamAPITest {

    @Test
    public void createsDataStreamItemRequestBuilder() {

        // given
        final String payloadString = UUID.randomUUID().toString();
        final ItemSource payload = createTestItemSource(payloadString);

        final ElasticsearchDataStreamAPI builder = new ElasticsearchDataStreamAPI();
    ...
    public void createsBatchRequestBuilder() throws Exception {
        ...
        final ElasticsearchDataStreamAPI builder = new ElasticsearchDataStreamAPI(serializer, deserializer);
