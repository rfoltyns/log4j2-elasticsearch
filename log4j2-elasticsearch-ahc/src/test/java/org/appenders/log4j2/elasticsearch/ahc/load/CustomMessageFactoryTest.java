...
public class CustomMessageFactoryTest extends SmokeTest {
    ...
    public void messageFactoryTest() {
        ...
        createLoggerProgrammatically(
                () -> createElasticsearchAppenderBuilder(true, true, getConfig().getProperty("secure", Boolean.class))
        );

        final ObjectMapper objectMapper = configuredMapper();
        final Logger logger = LogManager.getLogger(getConfig().getProperty("loggerName", String.class),
    ...
    private static class LogObject {
        ...
        public LogObject(final String userLog) {
