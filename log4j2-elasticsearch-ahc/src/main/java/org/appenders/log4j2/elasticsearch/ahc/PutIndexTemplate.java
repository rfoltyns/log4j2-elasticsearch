...
public class PutIndexTemplate extends SetupStep<Request, Response> {
     ...
     */
    public PutIndexTemplate(final String name, final ItemSource source) {
     ...
     * @param source Index template document
     */
    public PutIndexTemplate(final int apiVersion, final String name, final ItemSource source) {
    ...
    public Request createRequest() {
        final String uri = getVersionBasedUri();
