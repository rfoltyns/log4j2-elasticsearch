 ...
 */
public class AHCHttp extends BatchingClientObjectFactory<BatchRequest, IndexRequest> {
    ...
    public static class Builder extends BatchingClientObjectFactory.Builder<BatchRequest, IndexRequest> {
        ...
        @Override
        public final Builder withBackoffPolicy(final BackoffPolicy<BatchRequest> backoffPolicy) {
            return (Builder) super.withBackoffPolicy(backoffPolicy);
        }

        @Override
        public final Builder withFailedItemOps(final FailedItemOps<IndexRequest> failedItemOps) {
            return (Builder) super.withFailedItemOps(failedItemOps);
        }

        public Builder withBatchOperations(final BatchOperations<BatchRequest> batchOperations) {
    ...
    private class AHCResponseHandler implements ResponseHandler<BatchResult> {

        private final BatchRequest request;
        private final Function<BatchRequest, Boolean> failureHandler;

        public AHCResponseHandler(final BatchRequest request, final Function<BatchRequest, Boolean> failureHandler) {
