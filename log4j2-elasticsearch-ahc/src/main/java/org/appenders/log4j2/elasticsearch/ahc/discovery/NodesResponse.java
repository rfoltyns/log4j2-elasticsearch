...
public class NodesResponse implements Response {
    ...
    public NodesResponse(@JsonProperty("nodes") final Map<String, NodeInfo> nodes) {
        this.nodes = nodes;
    }
    ...
    @Override
    public NodesResponse withResponseCode(final int responseCode) {
        this.responseCode = responseCode;
        return this;
    }

    @Override
    public NodesResponse withErrorMessage(final String errorMessage) {
