...
public abstract class BatchingClientObjectFactory<BATCH_TYPE extends Batch<ITEM_TYPE>, ITEM_TYPE extends Item<?>>
    ...
    public BatchingClientObjectFactory(final BatchingClientObjectFactory.Builder<BATCH_TYPE, ITEM_TYPE> builder) {
    ...
    @Override
    public Function<BATCH_TYPE, Boolean> createFailureHandler(final FailoverPolicy failover) {
        return batchRequest -> {
    ...
    public Function<BATCH_TYPE, Boolean> createBatchListener(final FailoverPolicy failoverPolicy) {
        return new Function<BATCH_TYPE, Boolean>() {
            ...
            public Boolean apply(final BATCH_TYPE request) {
                ...
                final ResponseHandler<BatchResult> responseHandler = createResultHandler(request, failureHandler);
    ...
    public static abstract class Builder<BATCH_TYPE extends Batch<ITEM_TYPE>, ITEM_TYPE extends Item<?>> {
        ...
        public Builder<BATCH_TYPE, ITEM_TYPE> withName(final String name) {
            this.name = name;
            return this;
        }

        public Builder<BATCH_TYPE, ITEM_TYPE> withClientProvider(final HttpClientProvider clientProvider) {
            this.clientProvider = clientProvider;
            return this;
        }

        public Builder<BATCH_TYPE, ITEM_TYPE> withBackoffPolicy(final BackoffPolicy<BATCH_TYPE> backoffPolicy) {
            this.backoffPolicy = backoffPolicy;
            return this;
        }

        public Builder<BATCH_TYPE, ITEM_TYPE> withFailedItemOps(final FailedItemOps<ITEM_TYPE> failedItemOps) {
