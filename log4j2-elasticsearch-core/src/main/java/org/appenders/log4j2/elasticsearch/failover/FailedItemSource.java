...
public class FailedItemSource<T> implements ItemSource {

    private CharSequence failureId;
    ...
    CharSequence getFailureId() {
        return failureId;
    }

    FailedItemSource setFailureId(CharSequence failureId) {
