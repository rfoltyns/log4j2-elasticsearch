...
public abstract class KeySequenceConfigMixIn {
    ...
    @JsonCreator
    public KeySequenceConfigMixIn(
            @JsonProperty("seqId") long seqId,
            @JsonProperty("rIdx") long readerIndex,
            @JsonProperty("wIdx") long writerIndex
    ) {}
    ...
    @JsonProperty("rIdx")
    public abstract void setReaderIndex(long readerIndex);

    @JsonProperty("wIdx")
    public abstract long getWriterIndex();

    @JsonProperty("wIdx")
    public abstract void setWriterIndex(long writerIndex);
