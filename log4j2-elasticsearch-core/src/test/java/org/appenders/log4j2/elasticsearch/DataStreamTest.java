...
public class DataStreamTest {
    ...
    private DataStream createTestDataStream(final String name) {
    ...
    public void buildsWithName() {
        ...
        // when
        final DataStream plugin = createTestDataStream(TEST_DATA_STREAM_NAME);

        // then
        assertNotNull(plugin);
        assertNotNull(plugin.getName());
        assertNotNull(plugin.getSource());
        assertEquals(DataStream.TYPE_NAME, plugin.getType());
    ...
    public void builderThrowsWhenNameIsNotSet() {
        ...
        // when
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> createTestDataStream(null));
