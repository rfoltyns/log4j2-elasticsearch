...
public class RollingIndexNameFormatterRolloverTest {

    private final RollingIndexNameFormatter formatter = RollingIndexNameFormatter.newBuilder()
            .withPattern("yyyy-MM-dd HH:mm:ss.SSS")
            .withIndexName("log4j2-elasticsearch")
            .build();
